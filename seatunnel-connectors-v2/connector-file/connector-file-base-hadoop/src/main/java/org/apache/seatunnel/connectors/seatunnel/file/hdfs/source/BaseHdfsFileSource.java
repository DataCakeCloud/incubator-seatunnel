...
public abstract class BaseHdfsFileSource extends BaseFileSource {
    public void initHadoopConf(Config pluginConfig){
        ...
        if (pluginConfig.hasPath(HdfsSourceConfig.KEY_HADOOP_CONF.key())){
            Config config = pluginConfig.getConfig(HdfsSourceConfig.KEY_HADOOP_CONF.key());
            hadoopConf.setHadoopConfDetail(config);
        }
    }
    ...
    public void prepare(Config pluginConfig) throws PrepareFailException {
        ...
        initHadoopConf(pluginConfig);
        if(pluginConfig.hasPath(HdfsSourceConfig.FILE_FORMAT_TYPE.key())){
            readStrategy =
