...
public class DefaultDataConverter implements DataConverter {
    ...
    private Object convertToIceberg(@NonNull SeaTunnelDataType<?> seaTunnelType, @NonNull Type icebergType, Object seaTunnelValue) {
        if (icebergType == null || seaTunnelValue==null) {
            return null;
        }
        switch (icebergType.typeId()) {
            case STRING:
                return seaTunnelValue.toString();
            case BOOLEAN:
                return Boolean.class.cast(seaTunnelValue);
            case INTEGER:
                return Integer.parseInt(seaTunnelValue.toString());
            case LONG:
                return Long.parseLong(seaTunnelValue.toString());
            case FLOAT:
                return Float.parseFloat(seaTunnelValue.toString());
            case DOUBLE:
                return Double.parseDouble(seaTunnelValue.toString());
            case DECIMAL:
