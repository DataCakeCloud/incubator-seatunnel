...
public interface JdbcOptions {
    ...
    Option<List<String>> PRESQL =
            Options.key("preSql").listType().noDefaultValue().withDescription("preSql");

    Option<List<String>> POSTSQL =
            Options.key("postSql").listType().noDefaultValue().withDescription("postSql");
