...
public class CreateTableCommand implements Command<AbstractCommandArgs> {
    private final FlinkCommandArgs flinkCommandArgs;

    public CreateTableCommand(FlinkCommandArgs flinkCommandArgs) {
        this.flinkCommandArgs = flinkCommandArgs;
    }

    @Override
    public void execute() throws CommandExecuteException, ConfigCheckException {
        Boolean result = createTable();
        System.out.println("Seatunnel Action result:" + result);
    }
    ...
    public Boolean createTable() throws ActionFailException {
        ...
        if(internalSource instanceof SeaTunnelPluginAction){
            ...
            return actionSource.createTable();
        }
