...
public class GetSourceSampleCommand implements Command<AbstractCommandArgs> {
    private final FlinkCommandArgs flinkCommandArgs;

    public GetSourceSampleCommand(FlinkCommandArgs flinkCommandArgs) {
        this.flinkCommandArgs = flinkCommandArgs;
    }
    @Override
    public void execute() throws CommandExecuteException, ConfigCheckException {
        List<Map<String, String>> sample = getSample();
        System.out.println("Seatunnel Action result:" + JSON.toJSONString(sample) );
    }
