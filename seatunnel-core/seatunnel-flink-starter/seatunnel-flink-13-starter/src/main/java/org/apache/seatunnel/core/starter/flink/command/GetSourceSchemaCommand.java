...
public class GetSourceSchemaCommand implements Command<AbstractCommandArgs> {
    private final FlinkCommandArgs flinkCommandArgs;

    public GetSourceSchemaCommand(FlinkCommandArgs flinkCommandArgs) {
        this.flinkCommandArgs = flinkCommandArgs;
    }
    @Override
    public void execute() throws CommandExecuteException, ConfigCheckException {
        List<Map<String, String>> rowType = getSchema();
        System.out.println("Seatunnel Action result:" + JSON.toJSONString(rowType) );
    }
